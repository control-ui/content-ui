...
function handleUnderline(...[node, , context, safeOptions]: Parameters<ToMarkdownHandle>): ReturnType<ToMarkdownHandle> {
    const tracker = track(safeOptions)
    const exit = context.enter('underline' as ConstructName)
