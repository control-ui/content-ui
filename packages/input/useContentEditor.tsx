...
import { ContentSelection, ContentSelectionSettings, SelectionStore, useSelectionStore } from '@content-ui/react/ContentSelectionContext'
...
export const useContentEditor = (
    ...
    options?: {
        selectionSettings?: ContentSelectionSettings
    },
): WithContentEditor => {
    ...
    const editorSelectionStore = useSelectionStore(options?.selectionSettings)
    ...
    const handleOnChange: CodeMirrorOnChange = useCallback((v, newValue) => {
        ...
        editorSelectionStore?.setSelection(nextSelection)
